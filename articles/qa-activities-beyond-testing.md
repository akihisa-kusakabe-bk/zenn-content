...
| 時間軸 | いつやるか | たとえ（勉強） |
|---|---|---|
| **上流** | 作る前 | カリキュラム設計・教材選び（予防） |
| **中流** | 作りながら | 小テスト・理解度チェック（モニタリング） |
| **後工程＋横断** | 出した後＋常時 | 成績分析・勉強法の見直し（改善） |

![QA活動の全体マップとフィードバックループ](/images/qa-activities-beyond-testing/qa-activities-map.svg)
...
ここが一番コスパがいい。**バグは、作り込まれた後に見つけるより、作り込まれる前に防ぐほうがずっと安い**。
